...
public class SQLIngredientDAO implements IngredientDAO {
    ...
    private final String UPDATE_INGREDIENT_BY_ID_QUERY = "update ingredient set amount = ? where idingredient = ?";
    ...
    @Override
    public boolean updateIngredientAmountById(int id, int amount) throws DAOException{
        ConnectionPool connectionPool = null;
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ...
        try {
            connectionPool = ConnectionPool.getInstance();
            connection = connectionPool.takeConnection();
            preparedStatement = connection.prepareStatement(UPDATE_INGREDIENT_BY_ID_QUERY);
