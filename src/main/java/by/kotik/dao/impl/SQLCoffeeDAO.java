...
public class SQLCoffeeDAO implements CoffeeDAO {
    ...
    private final String UPDATE_COFFEE_AMOUNT_BY_ID_QUERY = "update coffee set amount = ? where idcoffee=?";
    ...
    public boolean updateCoffeeAmountById(int id, int amount) throws DAOException{
        ConnectionPool connectionPool = null;
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ...
        try {
            connectionPool = ConnectionPool.getInstance();
            connection = connectionPool.takeConnection();
            preparedStatement = connection.prepareStatement(UPDATE_COFFEE_AMOUNT_BY_ID_QUERY);
